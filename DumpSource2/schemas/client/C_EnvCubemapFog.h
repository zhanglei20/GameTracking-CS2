class C_EnvCubemapFog : public C_BaseEntity
{
	...
	int32 m_nHeightFogType;
	int32 m_nFogHeightBlendMode;
	int32 m_nFogHeightCoordinateSpace;
	int32 m_nDistanceFogType;
	CUtlSymbolLarge m_DistanceFogCurveString;
	CUtlSymbolLarge m_HeightFogCurveString;
