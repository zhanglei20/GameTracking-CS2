class CCSBot : public CBot
{
	...
	VectorWS m_approachPointViewPosition;
	...
	VectorWS m_targetSpot;
	Vector m_targetSpotVelocity;
	VectorWS m_targetSpotPredicted;
	QAngle m_aimError;
	QAngle m_aimGoal;
